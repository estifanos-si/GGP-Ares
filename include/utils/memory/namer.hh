...
namespace ares
{
    class Namer
    {
     ...
     public:
         ...
         */
        static inline std::string vname(const ushort& id)
        {
            return vIdName.at(id);
        }
        /**
         ...
         */
        static inline std::string name(const ushort& id)
        {
            return idName.at(id);
        }
        /**
        ...
        /**
         * Change the variable the id @param id to a versioned/renamed variable
         * id.
         */
