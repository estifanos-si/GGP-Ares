...
namespace ares
{
     ...
     * expressions are, names(char*) of predicates and terms, predicates and
     * terms.
     */
    class MemCache
    {
        ...
        typedef tbb::concurrent_hash_map<PoolKey, sFunction, PoolKeyHasher>
            FnPool;
        typedef tbb::concurrent_hash_map<PoolKey, sLiteral, PoolKeyHasher>
            AtomPool;
     ...
     private:
        /**
         * Only a single Memory cache should exist through out the life time of
         * the application and its created by the singleton MemoryPool.
         */
        MemCache() {}
     ...
     public:
        ...
        /**
         * if the function is in the pool, then the existing function is
         * returned. else a new function with name key.name and body key.body is
         * created. key.body is now owned by MemCache, and should neither be
         * deleted nor assigned to other objects at any point. This is to avoid
         * copying the body while creation.
         */
         ...
         * assigned to other objects at any point. This is to avoid copying the
         * body while creation.
         */
