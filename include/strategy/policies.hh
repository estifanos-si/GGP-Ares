...
namespace ares{
    ...
    public:
        ...
        virtual Montecarlo:: Node* operator()(Montecarlo::Node*,const std::atomic_bool&,Montecarlo::Ptype,ushort)const;
        ~SelectionPolicy() {}
    };
    ...
    public:
         ...
         */
        virtual std::vector<float> operator()(const State* state,std::atomic_bool&)const;
        ~SimPolicy() {}
    };
}
#endif