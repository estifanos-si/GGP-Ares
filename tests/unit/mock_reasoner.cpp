...
namespace ares
{
     ...
     */
    const State& MockReasoner::init() { return *game.init(); }
    /**
    ...
    ushort MockReasoner::roleIndex(ushort) const { return 0; }
    /**
     * Get a random move.
     */
    ...
    /**
     * Get a random action, i.e <move_1,...,move_n> , where move_i is taken by
     * role i.
     */
