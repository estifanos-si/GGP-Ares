...
namespace ares
{
     ...
     private:
        class Node
        {
         public:
            ...
            void addEqui(Action* a, Action* a2) { original[a] = a2; }
            ...
            const Transition& get() { return delta; }
            bool terminal() { return delta.size() == 0; }
            State* getState() { return self; }
        ...
        class GameTree
        {
         public:
            ...
            State* init() { return root->getState(); }
            ...
            void addEqui(State* s, State* s2) { original[s] = s2; }
    ...
    class MonteTester
    {
     ...
     public:
        ...
        std::vector<Montecarlo::Node*> TestExpansion(
